...
import com.resustainability.fincorehub.repository.RevenueBudgetRepository;
...
public class RevenueBudgetService {
    ...
    private final RevenueBudgetRepository budgetRepository;

    public RevenueBudgetService(RevenueBudgetRepository budgetRepository) {
        this.budgetRepository = budgetRepository;
    }

    @Transactional(isolation = Isolation.READ_COMMITTED,propagation = Propagation.REQUIRED)
    public RevenueBudgetMaster addBudget(AddRevenueBudgetRequest request) {
    	
        RevenueBudgetMaster budget = new RevenueBudgetMaster();
    ...
    @Transactional(isolation = Isolation.READ_COMMITTED,propagation = Propagation.REQUIRED)
    public Pager<IRevenueBudgetResponse> list(
            String bu,
            String site,
    ...
    @Transactional(isolation = Isolation.READ_COMMITTED,propagation = Propagation.REQUIRED)
    public IRevenueBudgetResponse getById(Long id) {
    ...
    public String updateBudget(
            Long id,
            UpdateRevenueBudgetRequest request) {
    ...
    public String deleteBudget(List<Long> ids) {
        ...
        List<RevenueBudgetMaster> budgets =
    ...
    public String uploadFromExcel(MultipartFile file) throws Exception {
        ...
        List<RevenueBudgetMaster> budgetList = new ArrayList<>();
        ...
        try (Workbook workbook =
            ...
            for (int i = 1; i <= lastRowIndex; i++) {
                ...
                if (financialYear.isEmpty()) {
                    ...
                    throw new Exception(
                            "Financial Year is missing at row "
                                    + displayRow
                    );
                }
             ...
             // Duplicate already existing in DB
             ...
             if (alreadyExists) {
                 ...
                 throw new Exception(
                         "Record already exists in database at row "
                                 + displayRow
                                 + " for BU="
                                 + bu
                                 + ", SBU="
    ...
    public byte[] exportBudget(
        ...
        List<RevenueBudgetMaster> budgetList =
        ...
        Sheet sheet =
                workbook.createSheet("Revenue Budget");
        ...
        for (RevenueBudgetMaster b : budgetList) {
