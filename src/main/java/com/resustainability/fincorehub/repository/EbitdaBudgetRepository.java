...
@Repository
public interface EbitdaBudgetRepository extends JpaRepository<EbitdaBudgetMaster, Long> {
	  ...
	  @Query("""
		    ...
		    """)
		    Page<IEbitdaBudgetResponse> findAllBudget(
		            @Param("bu") String bu,
		    ...
		    @Query("""
		        ...
		        WHERE b.id = :id
		    """)
		    Optional<IEbitdaBudgetResponse> findBudgetById(
		            @Param("id") Long id
		    );
		    ...
		    @Transactional
		    @Query("""
		        UPDATE EbitdaBudgetMaster b SET
		            b.bu = :bu,
		            b.sbu = :sbu,
		            b.site = :site,
		    ...
		    @Query("""
		    	    ...
		    	    AND
		    	        (:financialYear IS NULL OR :financialYear = ''
		    	            OR b.financialYear = :financialYear)
		    	""")
		    	List<EbitdaBudgetMaster> exportBudgetData(
		    	        @Param("bu") String bu,
		    	        @Param("site") String site,
		    	        @Param("financialYear") String financialYear
		    	);
