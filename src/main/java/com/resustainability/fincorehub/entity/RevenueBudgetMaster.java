...
@Entity
@Table(name = "revenue_budget_master", uniqueConstraints = {
	    @UniqueConstraint(columnNames = {"bu", "sbu", "site", "financialYear"})
	})
public class RevenueBudgetMaster {
	...
	public RevenueBudgetMaster() {

	}
	
	

	public RevenueBudgetMaster(Long id, String bu, String sbu, String site, String financialYear, Double apr, Double may,
